...

{
  ...
  networking.interfaces.ens19 = {
    ipv6.addresses = [{ address="2001:7f8:25::5:9552:1"; prefixLength = 64; }];
    ipv4.addresses = [{ address="193.201.149.1"; prefixLength = 26; }];
  };

  networking.interfaces.ens18 = {
    ipv4.addresses = [{ address="10.120.123.9"; prefixLength = 24; }];
  };
  ...
  deployment.targetHost = "10.120.123.9";
